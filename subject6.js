window.addEventListener("mousemove", function(chahcha){
    ...
    document.querySelector("#slidephoto").style.transform =`translate(${-chahcha.clientX*0.10}px, ${-chahcha.clientY*0.20}px)`
});
...
.addEventListener("mousemove", function(){
    document.querySelector("#slidephotos").style.marginTop = "-480%"
    document.querySelector("#tap").style.color = "rgb(177, 177, 177)"
})

document.querySelector("#tap")
.addEventListener("mouseleave", function(){
    document.querySelector("#tap").style.color = "initial"
})

document.querySelector("#so")
.addEventListener("mousemove", function(){
    document.querySelector("#slidephotos").style.marginTop = "-600%"
    document.querySelector("#so").style.color = "rgb(177, 177, 177)"
})

document.querySelector("#so")
.addEventListener("mouseleave", function(){
    document.querySelector("#so").style.color = "initial"
})

document.querySelector("#ps")
.addEventListener("mousemove", function(){
    document.querySelector("#slidephotos").style.marginTop = "-600%"
    document.querySelector("#ps").style.color = "rgb(177, 177, 177)"
})

document.querySelector("#ps")
.addEventListener("mouseleave", function(){
    document.querySelector("#ps").style.color = "initial"
})
